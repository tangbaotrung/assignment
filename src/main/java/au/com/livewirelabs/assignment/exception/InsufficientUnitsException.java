...
public class InsufficientUnitsException extends Exception {
  ...
  private static final long serialVersionUID = -2167747767758723710L;
   ...
   * @since  1.4
   */
  public InsufficientUnitsException(Throwable cause) {
      super(cause);
  }
   ...
   * @since 1.7
   */
  protected InsufficientUnitsException(String message, Throwable cause,
